...
if __name__ == "__main__":
    ...
    with open("python/DEVICES.txt", "r") as myfile:
        ...
        with open('../../../../../../Downloads/full/python/neighborships.json', 'w') as outfile:
        ...
        with open('../../../../../../Downloads/full/python/interfaces.json', 'w') as outfile:
        ...
        with open('../../../../../../Downloads/full/python/no_neighbor_interfaces.json', 'w') as outfile:
        ...
        with open('../../../../../../Downloads/full/python/graph.json', 'w') as outfile:
